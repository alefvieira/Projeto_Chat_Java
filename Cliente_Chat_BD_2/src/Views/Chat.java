...
//        vai verificar se foi digitado um nome
    ...
    private void setConversa(String message){
...
//        String cntTXT = lerArq.getConteudo_do_arquivo();
        mensagemRecebida.setText(message);
    }
            ...
            public void run(){
                ...
                try {
                    ...
                    while((message = br.readLine())!= null){
                       ...
                       msg = verificaPessoa(message);
                        
//                       String[] arr = message.split(" --- ");
//                        if(arr[0].equals(ConversaP)){
//                            mensagemRecebida.setText(mensagemRecebida.getText() +" "+  arr[1] + "\n   "+arr[2]);
////                            setConversa(message);;
//                        }   
...
//        }
        ...
        if(arr[0].equals(ConversaP)){
            ...
            for(int i = 1 ;i < arr.length ; i++){
                mensagemRecebida.setText(mensagemRecebida.getText()+ arr[i]+"\n");
            }
//             mensagemRecebida.setText(mensagemRecebida.getText() +"\n "+  arr[1] + "\n   "+arr[2]+"\n");
    ...
    private void contatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_contatosMouseClicked
        ...
        criarNomeArquivo(PessoaConversa, this.nome);

        verificaPessoa(ConversaP);
        enviarMensagem();
    ...
    private void contatosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_contatosMousePressed
        // TODO add your handling code here:
        int indicelinha = contatos.getSelectedRow();
        String PessoaConversa = contatos.getValueAt(indicelinha, 0).toString(); // converte em numero inteiro
        conversando.setText(PessoaConversa);
    ...
    }//GEN-LAST:event_contatosMousePressed
    ...
    public static void main(String args[]) {
        ...
        public void criarNomeArquivo(String nome1, String nome2){
        String[] arrToSort = {nome1, nome2}; // vai adicionar duas strings do nome das pessaos na conversa e depois vai ser executado o metodo sort que vai deixar em ordem alfabetica
        Arrays.sort(arrToSort, String.CASE_INSENSITIVE_ORDER);//case insensitive sort
        
        this.ConversaP = arrToSort[0] +"@"+ arrToSort[1];
        
        arquivoTXT = conServer.getArquivoTXT()+ ConversaP;
